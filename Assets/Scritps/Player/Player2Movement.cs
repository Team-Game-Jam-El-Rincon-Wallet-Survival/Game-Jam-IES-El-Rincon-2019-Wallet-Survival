...
public class Player2Movement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        bool pressKeyUp = Input.GetKey(KeyCode.W);
        bool pressKeyDown = Input.GetKey(KeyCode.S);
        bool pressKeyRigth = Input.GetKey(KeyCode.D);
        bool pressKeyLeft = Input.GetKey(KeyCode.A);
